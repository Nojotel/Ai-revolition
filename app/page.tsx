          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div
              className="w-1/2 flex flex-col items-start self-center lg:items-center lg:w-full lg:text-center bg-bgcolor rounded-lg p-4
						...
						"
            >
              <h1 className="!text-6xl !text-left xl: !text-5xl  lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl text-textlight">NIJI.AI</h1>
              <p className="my-4 text-base text-textlight font-medium md:text-sm sm:text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio pariatur et sint facilis sed rerum labore dolor numquam excepturi a voluptas nulla, minima laudantium, exercitationem aspernatur animi repellendus dolores eligendi.</p>
